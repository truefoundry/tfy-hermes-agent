...
- **Emit manifests without applying:** `TFY_SECRET_TENANT=tfy-eo node bin/tfy-hermes-agent.mjs deploy examples/agent.hermes.yaml --skip-live-checks --emit-manifests /tmp/out`.
