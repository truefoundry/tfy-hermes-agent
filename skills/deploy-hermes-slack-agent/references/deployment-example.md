...
Writes `hermes.yaml` and `slack-app-manifest.json`. Or copy `examples/agent.hermes.yaml`.
...
| `HERMES-RUN-TOKEN-SECRET` | `openssl rand -hex 32` — master HMAC for executor callbacks |
